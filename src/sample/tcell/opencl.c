...
// the th should be large using GPU, like 10000
// when the matrix size is smaller than the th, computing mal using gpu; 
// and using cpu to divide the larger size mztrix.
